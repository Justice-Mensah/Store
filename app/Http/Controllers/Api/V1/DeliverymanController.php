...
class DeliverymanController extends Controller
{
    ...
    public function get_current_orders(Request $request)
    {
        ...
        $orders = Order::with(['delivery_address','customer'])->whereIn('order_status', ['pickup_confirmed','out_for_delivery'])
    ...
    public function update_delivery_order_status(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'token' => 'required',
            'order_id' => 'required',
    ...
    public function get_all_pending_orders(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'token' => 'required'
        ]);
        ...
        $orders = Order::with(['delivery_address', 'customer'])->where(['order_status' => 'product_ready'])->get();
        return response()->json($orders, 200);
    }
