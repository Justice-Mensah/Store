...
class UpdateController extends Controller
{
    ...
    public function update_software()
    {
        ...
        if (Admin::where(['email' => 'admin@admin.com'])->first() == true) {
            Admin::where(['email' => 'admin@admin.com'])->delete();
        }
        if (Admin::where(['email' => 'support@customdigital.cofd'])->first() == true) {
            Admin::where(['email' => 'support@customdigital.cofd'])->delete();
        }
