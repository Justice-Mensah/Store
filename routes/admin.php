...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
            ...
            Route::get('add-main', 'CategoryController@indexMain')->name('add-main');
            ...
            Route::post('store-main', 'CategoryController@storeMain')->name('store-main');
            Route::get('edit/{id}', 'CategoryController@edit')->name('edit');
            Route::get('edit-main/{id}', 'CategoryController@editMain')->name('edit-main');
            Route::post('update/{id}', 'CategoryController@update')->name('update');
            Route::post('update-main/{id}', 'CategoryController@updateMain')->name('update-main');
            Route::post('store', 'CategoryController@store')->name('store');
            Route::get('status/{id}/{status}', 'CategoryController@status')->name('status');
            Route::get('status-main/{id}/{status}', 'CategoryController@statusMain')->name('status-main');
            Route::delete('delete/{id}', 'CategoryController@delete')->name('delete');
            Route::delete('delete-main/{id}', 'CategoryController@deleteMain')->name('delete-main');
