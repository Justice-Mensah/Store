...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::get('all-pending-orders', 'DeliverymanController@get_all_pending_orders');
        ...
        Route::put('update-delivery-order-status', 'DeliverymanController@update_delivery_order_status');
        ...
        Route::get('pickup-order-details', 'DeliverymanController@get_delivery_order_details');
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('wholesale', 'ProductController@get_wholesale_products');
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('/services', 'CategoryController@get_services');
    ...
    Route::group(['prefix' => 'sms'], function () {
        Route::get('/', 'SendSmsController@send_sms');
    });
    ...
    Route::group(['prefix' => 'language'], function () {
        Route::get('/', 'LanguageController@get');
    });
});
