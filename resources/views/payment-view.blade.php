...
<div class="container pb-5 mb-2 mb-md-4">
    <div class="row">
        ...
        <section class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body" style="height: 70px">
                                <button type="button" class="btn btn-block" data-toggle="modal"
                                        data-target="#point-system">
                                    <h4>Internal Point</h4>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="point-system" role="dialog" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                            ...
                            <center>
                                @if(($value*$order['order_amount'])<=$point)
                                    <label class="badge badge-soft-success">You have sufficient balance to
                                        proceed!</label>
                                @else
                                    <label class="badge badge-soft-danger">Your balance is insufficient!</label>
                                @endif
                            </center>
                        </div>
