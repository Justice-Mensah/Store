                        ...
                        <div class="hs-unfold float-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu text-capitalize" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item"
                                       onclick="route_alert('{{route('admin.orders.status',['id'=>$order['id'],'order_status'=>'product_ready'])}}','Change status to product ready ?')"
                                       href="javascript:">{{trans('messages.product_ready')}}</a>
                                    <a class="dropdown-item"
                                       onclick="route_alert('{{route('admin.orders.status',['id'=>$order['id'],'order_status'=>'pickup_confirmed'])}}','Change status to pickup confirmed ?')"
