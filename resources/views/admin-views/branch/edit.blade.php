        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize"><i class="tio-edit"></i> {{trans('messages.branch')}} {{trans('messages.update')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.branch.update',[$branch['id']])}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{trans('messages.password')}} <span class="" style="color: red;font-size: small">* ( input if you want to reset. )</span></label>
                    ...
                    @if(env('APP_MODE')=='demo')
                        <button type="button"
                                onclick="call_demo()"
                                class="btn btn-primary">{{trans('messages.update')}}
                        </button>
                    @else
