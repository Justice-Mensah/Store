                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-lg mb-3 mb-lg-0">
                            <h1 class="page-header-title">{{trans('messages.product')}} {{trans('messages.report')}} {{trans('messages.overview')}}</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control js-select2-custom" name="product_id"
                                        ...
                                        <option
                                            value="0">{{trans('messages.select')}} {{trans('messages.product')}}</option>
                                ...
                                <div class="col-2">
                                    <button type="submit"
                                            class="btn btn-primary btn-block">{{trans('messages.show')}}</button>
                                </div>

                                <div class="col-md-6 pt-4">
                                    <strong>
                                        {{trans('messages.total')}} {{trans('messages.orders')}} : <span
                                            id="order_count"> </span>
                                    </strong><br>
                                    <strong>
                                        {{trans('messages.total')}} {{trans('messages.item')}} {{trans('messages.qty')}} : <span
                                            id="item_count"> </span>
                                    </strong><br>
                                    <strong>{{trans('messages.total')}}  {{trans('messages.amount')}} : <span
