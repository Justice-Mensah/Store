                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-lg mb-3 mb-lg-0">
                            <h1 class="page-header-title">{{trans('messages.driver')}} {{trans('messages.report')}} {{trans('messages.overview')}}</h1>
                ...
                <div class="card-header">
                    <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1"
                                                   class="form-label">{{trans('messages.show')}} {{trans('messages.data')}}
                                                by {{trans('messages.date')}}
                        ...
                        <div class="col-md-6 pt-2">
                            <strong>
                                {{trans('messages.total')}}  {{trans('messages.delivered')}} {{trans('messages.qty')}} :
