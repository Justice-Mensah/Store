    ...
    <div class="content container-fluid">
        ...
        <div class="card card-body mb-3 mb-lg-5">
            <div class="row gx-lg-4">
                ...
                <div class="col-sm-6 col-lg-3 column-divider-lg">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.orders.list',['product_ready'])}}'">
                        <div class="media-body">
                            <h6 class="card-subtitle">{{trans('messages.product_ready')}}</h6>
                            <span class="card-title h3">{{\App\Model\Order::where(['order_status'=>'product_ready'])->count()}}</span>
                        </div>
                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                          <i class="tio-checkmark-circle"></i>
                        </span>
                ...
                <div class="col-sm-6 col-lg-3 column-divider-lg">
                    <div class="media" style="cursor: pointer" onclick="location.href='{{route('admin.orders.list',['pickup_confirmed'])}}'">
                        <div class="media-body">
                            <h6 class="card-subtitle">{{trans('messages.pickup_confirmed')}}</h6>
                            <span class="card-title h3">{{\App\Model\Order::where(['order_status'=>'pickup_confirmed'])->count()}}</span>
                        </div>
                        <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
                          <i class="tio-running"></i>
                        </span>
