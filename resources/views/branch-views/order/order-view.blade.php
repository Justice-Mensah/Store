                ...
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <div class="d-sm-flex align-items-sm-center">
                        ...
                        @elseif($order['order_status']=='processing')
                            ...
                            @elseif($order['order_status']=='product_ready')
                            <span class="badge badge-soft-warning ml-2 ml-sm-3 text-capitalize">
                              <span class="legend-indicator bg-warning"></span>{{trans('messages.product_ready')}}
                            </span>
                            @elseif($order['order_status']=='pickup_confirmed')
                            <span class="badge badge-soft-warning ml-2 ml-sm-3 text-capitalize">
                              <span class="legend-indicator bg-warning"></span>{{trans('messages.pickup_confirmed')}}
                            </span>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item"
                                       ...
                                       <a class="dropdown-item"
                                       onclick="route_alert('{{route('branch.orders.status',['id'=>$order['id'],'order_status'=>'product_ready'])}}','Change status to Order Ready ?')"
                                       href="javascript:">{{trans('messages.product_ready')}}</a>
                                       <a class="dropdown-item"
                                       onclick="route_alert('{{route('branch.orders.status',['id'=>$order['id'],'order_status'=>'pickup_confirmed'])}}','Change status to Pickup confirmed ?')"
                                       href="javascript:">{{trans('messages.pickup_confirmed')}}</a>
                                    <a class="dropdown-item"
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            ...
                                            <div class="col col-md-2 align-self-center">
                                                <h5>{{$detail['quantity']}} {{trans('messages.'.$detail['unit'])}}</h5>
                                            </div>
                    ...
                    @if($order->customer)
                        <div class="card-body">
                            ...
                            <div class="media align-items-center" href="javascript:">
                                ...
                                <div class="media-body">
                                    <span class="text-body text-hover-primary">{{\App\Model\Order::where('user_id',$order['user_id'])->count()}} {{trans('messages.orders')}}</span>
                                </div>
                                <div class="media-body text-right">
                                    {{--<i class="tio-chevron-right text-body"></i>--}}
                                </div>
